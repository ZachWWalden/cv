...
\section{Skills}
	\subsection{Software}
		\subsubsection{\large{Languages}} \large{C/C++} \small{(Embedded(RTOS, PIC, STM32, AVR), Linux, Windows)}\large{, Python, Assembly} \small{(AVR)} \large{, Verilog} \small{(CocoTb)} \large{\tab, MATLAB/Simulink, Java} \small{(General, Android)} \large{, Bash}
