...
\section{Skills}
	\subsection{Software}
		\subsubsection{Languages} \large{C/C++} \small{(Embedded(RTOS, PIC, STM32, AVR), Linux, Windows)}\large{, Python, Assembly} \small{(AVR)} \large{, Verilog} \small{(CocoTb)} \large{\tab, MATLAB/Simulink, Java} \small{(General, Android)} \large{, Bash}
...
\section{Projects}
	...
	\subsection{DC/DC Boost Converter \hfill \normalfont{\small{\textsl{Sep. 2020 - Nov. 2020}}}}
		\begin{itemize}[label=--,itemsep=-.35ex]
			...
			\item \large{Led 3 person team.u}
		\end{itemize}
