...
\section{Skills}
		...
		\subsubsection{Design} \large{\hspace*{2pt} Kicad}, \large{Cadence Design Entry CIS, Digital} \small{(Microcontrollers, FPGA), }\large{Analog} \small{(Op-Amps, Transistors, Diodes)}
...
\section{Experience}
		\subsubsection{\large{Home Caregiver}} \hfill \small{\textsl{May 2022 - Present}}
