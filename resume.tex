...
\section{Experience}
	\subsection{VisuALS Technology Solutions, LLC}
		\subsubsection{\large{Open Source Strategist}} \hfill \small{\textsl{May 2022 - Present}}
			\begin{itemize}[label=--,itemsep=-.35ex]
				\item \large{Performed software testing of a Windows Presentation Foundation app on Windows VMs}
